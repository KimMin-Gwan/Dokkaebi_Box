...
class dokkaebi_ChatBot_Handover:
    def __init__(self, data):
        ...
        self.chatbot_data = pd.read_excel("C:/Users/maths/Documents/GitHub/Dokkaebi_Box/The_Systems/Find_Service/Find/ChatBot/chatbot_data_handover.xlsx")
        self.chat_dic = {}
        self.initChatBot()
        self.step = 1
            ...
            if index > -1:
                if self.chatbot_data['type'][k] == "classification":
                    ...
                    if self.lang == "Ko":
                        ...
                        hour = enResponse[2]
                        minute = enResponse[3]
                        dokkaebi_response_str = "You got it at " + day + "/" + month + " " + hour + ":" + minute +", Right?"
                    if len(month) == 1:
                        month = "0" + month
                    if len(day) == 1:
                        day = "0" + day
    ...
    def geocoding(self, address):
        ...
        return crd
    def fun1(self, usrResponse):   # 기존 step 1
    ...
    def fun2(self, usrResponse): # 기존 step 2
        self.rspFlag = 1
    ...
    def fun3(self, usrResponse):    # 기존 step 3
        self.rspFlag = 1
    ...
    def runChatBot(self):
        ...
        while True:
            if self.step == 1:
                ...
                print("물건을 어디에서 주우셨나요?"if self.lang == "Ko" else "Where did you find it?")
                while True:
                    dokkaebi_Response = '무슨말인지 잘 모르겠어요' if self.lang == "Ko" else "Sorry, I can't understand"
                    userResponse = input('입력(Input) : ')
                        ...
                        for rst in nlpResult:
                            try:
                                ...
                                if float(crd['lat']) >= SEOULLOWERBOUNDARY and float(
                                    ...
                                    self.dokkaebi_data.lng = crd['lng']
                                    if self.lang == "Ko":
                                        print('{}을(를) 습득하신 곳은 {} 이군요.'.format(self.dokkaebi_data.lostItem,
